...
public class detailController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //Do đây không phải trang xuất phát nên không cần để ý đến trường hợp service bằng null
            DAOGame daoGame = new DAOGame();
            DAOGenre daoGenre = new DAOGenre();
            if(service.equals("showDetail")){
                String gid = request.getParameter("gid");
                Vector<Game> list = daoGame.getGame("select * from Games where GameID = "+gid);
                //Game detail
                request.setAttribute("gameDetail", list);
